      ...
      <div className="hidden lg:flex w-1/2 flex-col justify-between bg-[#1e1b4b] p-10">
        ...
        <div className="space-y-4">
          <blockquote className="text-xl font-medium leading-relaxed text-white">
            "Agile keeps our onboarding running like clockwork — no more dropped balls at go-live."
          </blockquote>
          <p className="text-sm text-indigo-300">Sarah K. — Head of Customer Success</p>
        </div>
